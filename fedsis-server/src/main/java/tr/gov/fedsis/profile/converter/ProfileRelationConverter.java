 ...
 */
@Component
public class ProfileRelationConverter extends AbstractBaseConverter<ProfileRelationDto, ProfileRelation> {
    ...
    @Autowired
    public ProfileRelationConverter(DepartmentConverter departmentConverter, ProfileTypeConverter profileTypeConverter, ProfileConverter profileConverter, ClubTeamConverter clubTeamConverter) {
